...
const BeerBoxes = ({ beers, prefilledBeer, setPrefilledBeer }) => {
            ...
            {beers.map((beer) => 
                ...
                <div className="card bg-warning border-dark" key={beer.id}>
                    ...
                    <div className="card-footer">
                        <button className="btn beer_button m-2" onClick={() => {
                         if (openModal) {
...
<FormModal
              ...
              >
                        ...
                        <FormModal.Body>
                            {/* Modal Body */}
                            <Form_v2 prefilledBeer={prefilledBeer}/> {/* Use Form to see previous version */}
                        </FormModal.Body>
                        <FormModal.Footer>
